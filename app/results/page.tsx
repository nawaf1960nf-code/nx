...
export default function ResultsPage() {
  ...
  // تكشف نتيجة الفائز بعد ثانية لتأثير المفاجأة
  useEffect(() => {
    if (!mounted) return;
      ...
      <div className="max-w-2xl mx-auto px-6 py-6 text-center relative z-10">
        ...
        {!revealed && (
          <div className="py-20 animate-pulse">
            ...
            <p className="text-ink-500">يجاري احتساب النقاط</p>
          </div>
        )}
        ...
        {revealed && winner && (
          <>
            ...
            <div
              className="inline-flex items-center gap-2 bg-gold-500/15 text-gold-700 px-4 py-1.5 rounded-full font-bold text-xs mb-4 animate-float-up"
        ...
        {revealed && (
          <div
            className="grid sm:grid-cols-2 gap-3 mb-8 animate-float-up"
          ...
          <div className="min-w-0">
            <div
              className={cn(
                ...
                isWinner ? "text-white/70" : "text-ink-400",
              )}
            >
